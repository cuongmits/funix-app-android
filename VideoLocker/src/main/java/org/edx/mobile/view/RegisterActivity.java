...
import org.edx.mobile.module.prefs.PrefManager; //keon
...
public class RegisterActivity extends BaseFragmentActivity
    ...
    private void createAccount() {
        if (NetworkUtil.isConnected(this)) {
            ...
            //Bundle parameters = new Bundle(); //keon
                    ...
                    if (result != null) {
                        ...
                        if (!result.isSuccess()) {
                            ...
                            if (auth != null && auth.isSuccess()) {
                                ...
                                // KEON: catch username & password and save for REST request later
                                PrefManager pref = new PrefManager(context, PrefManager.Pref.LOGIN);
                                pref.put(PrefManager.Key.AUTH_REST, "Basic " + Base64.encodeToString((parameters.getString("username") + ":" + parameters.getString("password")).getBytes(), Base64.NO_WRAP));
                                pref.put(PrefManager.Key.AUTH_REST_CHECKER, parameters.getString("username") + ":" + parameters.getString("password"));
