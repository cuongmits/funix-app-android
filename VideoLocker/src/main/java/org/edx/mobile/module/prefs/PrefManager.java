...
public class PrefManager {
    ...
    public static final class Key {
        ...
        public static final String AUTH_REST = "auth_rest"; //keon
        public static final String AUTH_REST_CHECKER = "auth_rest_checker"; //keon
    }
    ...
    /**
     * Returns rest authorization for current user from the preferences.
     * @return
     */
    public String getCurrentRestAuth() {
        String s = getString(PrefManager.Key.AUTH_REST);
        if (s == null) {
            return null;
        }
        return s;
    ...
    /**
     * Clears rest auth token info and current profile information from preferences.
     */
    public void clearRestAuth() {
        put(PrefManager.Key.AUTH_REST, null);
        put(PrefManager.Key.AUTH_REST_CHECKER, null);
        //assessment webview related session_id
        EdxCookieManager.getSharedInstance().clearWebWiewCookie(MainApplication.instance());
    }
     ...
     * @return
     */
    public String getCurrentRestAuthChecker() {
        String s = getString(PrefManager.Key.AUTH_REST_CHECKER);
        if (s == null) {
            return null;
        }
        return s;
